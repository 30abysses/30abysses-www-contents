...
網路上是可以找到些關於 `GetHashCode()`  的(零碎)討論，但這篇文章將從最有
...
* [MSDN `GetHashCode()`  官方文件][1]
* [`coreclr` 原始碼(source code)][5]
* "[Guidelines and rules for GetHashCode][6]" by **Eric Lippert**

[5]: https://github.com/dotnet/coreclr
[6]: https://blogs.msdn.microsoft.com/ericlippert/2011/02/28/guidelines-and-rules-for-gethashcode/
